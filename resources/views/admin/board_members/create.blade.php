...
@section('title', 'Add Board / Council Member')
          ...
          <div class="adm-lang-pane is-active" data-lang="en">
            <div class="adm-form-group">
              ...
              <input type="text" name="name_en" id="name_en" class="adm-input @error('name_en') is-invalid @enderror" 
                     value="{{ old('name_en') }}" placeholder="e.g. Alhaj Mohammad Hossain" required>
              @error('name_en')
            ...
            <div class="adm-form-group">
              ...
              <input type="text" name="designation_en" id="designation_en" class="adm-input @error('designation_en') is-invalid @enderror" 
                     value="{{ old('designation_en') }}" placeholder="e.g. Chairman & Chief Patron" required>
            ...
            <div class="adm-form-group">
              ...
              <textarea name="bio_en" id="bio_en" rows="5" class="adm-textarea" 
                        placeholder="Short biography, professional achievements, or executive summary...">{{ old('bio_en') }}</textarea>
            </div>
          </div>
          ...
          <div class="adm-lang-pane" data-lang="bn">
            <div class="adm-form-group">
              ...
              <input type="text" name="name_bn" id="name_bn" class="adm-input @error('name_bn') is-invalid @enderror" 
                     value="{{ old('name_bn') }}" placeholder="e.g. আলহাজ্ব মোহাম্মদ হোসেন">
              @error('name_bn')
                <div class="text-danger small mt-1">{{ $message }}</div>
              @enderror
            </div>
            ...
            <div class="adm-form-group">
              ...
              <input type="text" name="designation_bn" id="designation_bn" class="adm-input @error('designation_bn') is-invalid @enderror" 
                     value="{{ old('designation_bn') }}" placeholder="e.g. চেয়ারম্যান ও প্রধান পৃষ্ঠপোষক">
            ...
            <div class="adm-form-group">
              ...
              <textarea name="bio_bn" id="bio_bn" rows="5" class="adm-textarea" 
                        placeholder="সংক্ষিপ্ত জীবনী, কর্মপরিচয় বা বার্তা...">{{ old('bio_bn') }}</textarea>
            </div>
          </div>
        </div>
      </div>
            ...
            <div class="col-md-6 col-12">
              <div class="adm-form-group">
                ...
                <input type="email" name="email" id="email" class="adm-input" 
                       value="{{ old('email') }}" placeholder="member@wotm.org">
              </div>
            </div>
            ...
            <div class="col-md-6 col-12">
              <div class="adm-form-group">
                ...
                <input type="url" name="social_links[twitter]" id="social_twitter" class="adm-input" 
                       value="{{ old('social_links.twitter') }}" placeholder="https://x.com/username">
              </div>
            </div>
            <div class="col-md-6 col-12">
              <div class="adm-form-group">
    ...
    <div class="col-lg-4 col-12">
        ...
        <div class="adm-card-body">
          <div class="adm-form-group">
            ...
            <select name="type" id="type" class="adm-select @error('type') is-invalid @enderror" required>
              <option value="chairman" {{ old('type', request()->get('type')) === 'chairman' ? 'selected' : '' }}>
                Chairman & Leadership
              </option>
              <option value="director" {{ old('type', request()->get('type', 'director')) === 'director' ? 'selected' : '' }}>
                Board of Director
              </option>
              <option value="advisor" {{ old('type', request()->get('type')) === 'advisor' ? 'selected' : '' }}>
                Advisory Council Member
              </option>
            </select>
            <div class="form-text small text-muted">
              Select <strong>Chairman</strong> to manage Chairman profile separately and display prominently at the top.
            </div>
          </div>
          ...
          <div class="adm-form-group">
            ...
            <input type="number" name="order" id="order" class="adm-input" 
                   value="{{ old('order', 0) }}" min="0" step="1">
          ...
          <div class="adm-form-group mb-0">
            <label class="adm-label d-flex align-items-center gap-2 cursor-pointer">
              <input type="checkbox" name="is_active" value="1" {{ old('is_active', '1') ? 'checked' : '' }} class="form-check-input mt-0">
      ...
      <div class="adm-card mb-4">
        ...
        <div class="adm-card-body text-center">
          <div class="mb-3">
            <img id="memberPhotoPreview" src="{{ asset('images/avatar-placeholder.png') }}" 
          ...
          <p class="small text-muted mb-0">
            Recommended: Square photo (800x800 px). Max: 3MB (JPG, PNG, WebP). If left empty, default vector avatar placeholder is used.
          </p>
        </div>
      </div>
      ...
      <div class="adm-card">
        <div class="adm-card-body d-flex flex-column gap-2">
          <button type="submit" class="adm-btn adm-btn-primary w-100 justify-content-center py-2">
            <i class="fa-solid fa-floppy-disk me-1"></i> Save Member Profile
          </button>
