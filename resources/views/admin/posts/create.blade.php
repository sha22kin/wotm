        ...
        <div class="adm-card-body">
          ...
          <div class="adm-lang-pane is-active" data-lang="en">
            <div class="adm-form-group">
              ...
              <input type="text" name="title_en" id="title_en" class="adm-input" value="{{ old('title_en') }}" placeholder="Enter English post title" required>
            </div>

            <div class="adm-form-group">
              <label class="adm-label" for="excerpt_en">Short Summary / Excerpt (English)</label>
              <textarea name="excerpt_en" id="excerpt_en" class="adm-textarea adm-textarea-sm" placeholder="Brief highlight of the article...">{{ old('excerpt_en') }}</textarea>
            </div>

            <div class="adm-form-group">
              <label class="adm-label">Full Article Content (English)</label>
              <div id="quillEditorEn" class="adm-quill-editor">{!! old('content_en') !!}</div>
          ...
          <div class="adm-lang-pane" data-lang="bn">
            <div class="adm-form-group">
              ...
              <input type="text" name="title_bn" id="title_bn" class="adm-input" value="{{ old('title_bn') }}" placeholder="পোস্টের বাংলা শিরোনাম লিখুন" required>
            </div>

            <div class="adm-form-group">
              <label class="adm-label" for="excerpt_bn">Short Summary / Excerpt (Bangla)</label>
              <textarea name="excerpt_bn" id="excerpt_bn" class="adm-textarea adm-textarea-sm" placeholder="পোস্টের সংক্ষিপ্ত বিবরণ...">{{ old('excerpt_bn') }}</textarea>
            </div>

            <div class="adm-form-group">
              <label class="adm-label">Full Article Content (Bangla)</label>
              <div id="quillEditorBn" class="adm-quill-editor">{!! old('content_bn') !!}</div>
              <input type="hidden" name="content_bn" id="content_bn" value="{{ old('content_bn') }}">
            </div>
          </div>
        </div>
      </div>
      ...
      <div class="adm-card">
        ...
        <div class="adm-card-body">
          <div class="adm-form-group">
            ...
            <input type="text" name="meta_title" id="meta_title" class="adm-input" value="{{ old('meta_title') }}" placeholder="Custom SEO Title">
          </div>

          <div class="adm-form-group">
            <label class="adm-label" for="meta_description">Meta Description</label>
            <textarea name="meta_description" id="meta_description" class="adm-textarea adm-textarea-sm" placeholder="Search engine snippet summary">{{ old('meta_description') }}</textarea>
          </div>

          <div class="adm-form-group">
            <label class="adm-label" for="meta_keywords">Meta Keywords</label>
            <input type="text" name="meta_keywords" id="meta_keywords" class="adm-input" value="{{ old('meta_keywords') }}" placeholder="e.g. flood relief, donation, news">
          </div>
        </div>
      </div>
    </div>
      ...
      <div class="adm-card">
        ...
        <div class="adm-card-body">
          ...
          <div class="adm-form-group">
            ...
            <input type="text" name="author_name" id="author_name" class="adm-input" value="{{ old('author_name', auth()->user()->name ?? 'WOTM') }}">
          </div>

          <div class="adm-form-group">
            <label class="adm-label" for="published_at">Publish / Schedule Date</label>
            <input type="datetime-local" name="published_at" id="published_at" class="adm-input" value="{{ old('published_at', now()->format('Y-m-d\TH:i')) }}">
          </div>

          <div class="adm-form-group">
            <label class="adm-label" for="slug">Custom URL Slug (Optional)</label>
            <input type="text" name="slug" id="slug" class="adm-input" value="{{ old('slug') }}" placeholder="auto-generated-if-blank">
          </div>
      ...
      <div class="adm-card">
        ...
        <div class="adm-card-body">
          <div class="adm-form-group mb-0">
            ...
            <div class="adm-input-hint">Formats: JPG, PNG, WebP. Recommended: 800x500.</div>
          </div>
        </div>
      </div>
    </div>
